        ...
        tempAudio.addEventListener("loadedmetadata", async () => {
          ...
          if (isNaN(duration) || duration <= 0) {
            ...
            duration =
              wavDur !== null
                ? wavDur
                : Math.max(0.5, (file.size * 8) / 128000);
          }
            ...
            {project.audioAssets.length === 0 ? (
              <div className="empty-assets">
                ...
                <p className="sub-text">
                  Add MP3, WAV, or AAC voiceovers or music tracks to place on
                  the timeline.
                </p>
              </div>
            ) : (
              <>
                ...
                >
                  💡 Click <strong>Place at Playhead</strong> on any imported
                  file to add it onto the timeline.
                </p>
