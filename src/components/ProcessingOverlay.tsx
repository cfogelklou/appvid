...
export const ProcessingOverlay: React.FC<ProcessingOverlayProps> = ({
  ...
  let stallMessage =
    "Processing files locally. Your media never leaves your device.";
  if (elapsedSeconds >= 10 && elapsedSeconds < 30) {
    ...
    stallMessage =
      "High-quality encoding can take several minutes. Keep this tab open.";
  } else if (elapsedSeconds >= 90 && elapsedSeconds < 180) {
    stallMessage =
      "Still working. If your device is low on memory, this export may fail.";
    ...
    <div className="processing-backdrop glass-panel">
      <div className="processing-card glass-panel">
        ...
        <div className="local-warning">
          ...
          Your files are processed locally in your browser. Do not close this
          tab.
        </div>
