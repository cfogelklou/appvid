...
export const Timeline: React.FC = () => {
  ...
  const handleAudioSegmentContextMenu = (e: React.MouseEvent, segId: string) => {
    e.preventDefault();
    e.stopPropagation();
      ...
      >
        <div className='timeline-content' ref={contentRef} style={{ width: `${contentWidth}px` }}>
          ...
          <div className='timeline-tracks'>
                      ...
                      {Array.from(cuesByLane.values()).map(({ lane, cue }) => {
                        ...
                        return (
                          <IntervalClip
                            ...
                            onContextMenu={(e) => handleTextCueContextMenu(e, cue.id)}
                            lane={lane}
            ...
            <TimelineTrack onAudioSegmentContextMenu={handleAudioSegmentContextMenu} />
          </div>
