    ...
    <header className="top-bar">
      ...
      <div className="top-bar-actions">
        {hasDraft && !project.video && (
          <button className="btn btn-secondary btn-sm" onClick={restoreDraft} title="Restore last draft">
            <Save size={16} />
            <span>Restore Draft</span>
          </button>
        )}
        <button className="btn btn-secondary btn-sm" onClick={saveDraft} title="Save project draft metadata">
          <Save size={16} />
