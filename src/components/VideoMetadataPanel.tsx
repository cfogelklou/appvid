    ...
    <div className='metadata-panel appvid-card'>
      ...
      {isNewFile && (
        <>
          ...
          >
            <span className='metadata-label' style={{ display: 'block', marginBottom: '8px' }}>
              Audio Handling
            </span>
            <div
              style={{
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Extracts video audio onto the timeline so you can edit, trim, or delete it
                    independently. The base video will be muted.
                  </div>
                </div>
              </label>
              <label
              ...
              >
                ...
                <div>
                  ...
                  >
                    Keeps audio built directly inside the video file. Cannot be trimmed or deleted
                    on the timeline.
                  </div>
                </div>
              </label>
